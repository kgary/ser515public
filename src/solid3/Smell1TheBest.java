...
public class Smell1TheBest {
	...
	public static void main(String[] args) {
		...
		// What is the problem here? What happens when I want to change the power
		// implementation?
		...
		for (int j = 1; j < args.length; j++) {
			System.out.println("SIMPLE: The " + args[j] + "th power of " + num + " is "
					+ simplePower.toPower(num, Integer.parseInt(args[j])));
			//System.out.println("CACHED: The " + args[j] + "th power of " + num + " is " +
			//cachedPower.toPower(num, Integer.parseInt(args[j])));
		}
