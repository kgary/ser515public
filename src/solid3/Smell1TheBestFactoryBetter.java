...
public class Smell1TheBestFactoryBetter {
	...
	public static void main(String[] args) {
		if (args.length < 2) {
			System.out.println(
					"Usage: java -Dpower=<power classname> solid3.Smell1TheBestFactoryBetter <num> <pow>+");
			System.exit(-1);
		}

		// Now the client (this main program) doesn't have to know how many
		...
		for (int j = 1; j < args.length; j++) {
			System.out.println("The " + args[j] + "th power of " + num + " is "
					+ thePower.toPower(num, Integer.parseInt(args[j])));
		}
